...
//go:generate swagger generate server --target ../pkg/gen/k9server --name  --spec ../openapi/k9server/openapi.yaml --server-package server --exclude-main

func configureFlags(api *operations.K9ServerAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.K9ServerAPI) http.Handler {
	...
	api.ZoneCreateZoneHandler = zone.CreateZoneHandlerFunc(func(params zone.CreateZoneParams) middleware.Responder {
		return middleware.NotImplemented("operation zone.CreateZone has not yet been implemented")
	})
